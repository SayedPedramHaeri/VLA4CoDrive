...
This project is licensed under the [MIT License](https://opensource.org/license/MIT). The dataset was generated using the CARLA simulator. It is intended for research purposes in autonomous driving and AI.
